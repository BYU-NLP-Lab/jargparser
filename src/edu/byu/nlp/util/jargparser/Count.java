...
import edu.byu.nlp.util.jargparser.arghandlers.BaseReflectiveVariableOption;
...
public class Count implements OptionHandlerFactory {
	 ...
	 */
	@Override
	public OptionHandler newHandler(ArgumentParser p, final ReflectiveVariable var, Option opt, Object optObject, List<String> optStrings) {
		if ( opt.nargs() > 0 )
