...
public class OptionConflictError extends IllegalArgumentException {
	...
	public OptionConflictError(OptionHandler failedOpt, ArgumentParser parser) {
	...
	private static String buildMessage(OptionHandler failedOpt, ArgumentParser parser) {
