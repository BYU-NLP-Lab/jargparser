...
import edu.byu.nlp.util.joptparse.opthandlers.StoreBooleanArrayFieldOption;
import edu.byu.nlp.util.joptparse.opthandlers.StoreByteArrayFieldOption;
import edu.byu.nlp.util.joptparse.opthandlers.StoreChoicesOption;
import edu.byu.nlp.util.joptparse.opthandlers.StoreCollectionOption;
import edu.byu.nlp.util.joptparse.opthandlers.StoreDoubleArrayFieldOption;
import edu.byu.nlp.util.joptparse.opthandlers.StoreFieldOption;
import edu.byu.nlp.util.joptparse.opthandlers.StoreFloatArrayFieldOption;
import edu.byu.nlp.util.joptparse.opthandlers.StoreIntArrayFieldOption;
import edu.byu.nlp.util.joptparse.opthandlers.StoreLongArrayFieldOption;

class Store implements OptionHandlerFactory {

	@Override
	public OptionHandler newHandler(OptionParser p, ReflectiveVariable var, Option opt, Object optObject, List<String> optStrings) {
		...
		if (var.getType().isArray()) {
			...
			Class<?> type = OptionParser.toWrapper(var.getType());
