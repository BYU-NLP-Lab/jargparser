...
//		opts.properties().list(System.out);
	...
	public void testParseArgs6() {
		...
		assertEquals(((List<Integer[]>)args.getValue("t")).get(0),new Integer[]{3,4,5});
		assertEquals(((List<Integer[]>)args.getValue("t")).get(1),new Integer[]{1,0,-1});
		assertEquals(((List<Integer[]>)args.getValue("t")).get(2),new Integer[]{5,4,6});
	}
	...
	public void testParseArgs7() {
		...
		ArgumentValues args = parser.parseArgs("-t3 4 5 -t1 0 -1 -t5 4 6".split("\\s+"));
		assertEquals(Arrays.asList(5,4,6),args.getValue("t"));
	}
